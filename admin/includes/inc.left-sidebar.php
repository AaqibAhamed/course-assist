            ...
            <ul id="sidebarnav" class="pt-4">
              <li class="sidebar-item">
                <a
                  ...
                  href="administrator.php?menu=dashboard&action=dashboard"
                  aria-expanded="false"
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Faculty </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="administrator.php?menu=faculty&action=all-faculty" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> All Faculty</span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="administrator.php?menu=faculty&action=add-faculty" class="sidebar-link"
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="administrator.php?menu=department&action=all-department" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> All Department</span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="administrator.php?menu=department&action=add-department" class="sidebar-link"
                      ><i class="mdi mdi-note-plus"></i
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="administrator.php?menu=Program&action=all-Program" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> All Program</span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="administrator.php?menu=Program&action=add-Program" class="sidebar-link"
                      ><i class="mdi mdi-note-plus"></i
                      ><span class="hide-menu"> Add Program </span></a
                    >
                  </li>
                </ul>
              </li>
